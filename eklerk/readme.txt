  ...
  <settings
     ...
     <profiles>
        <profile>
           ...
           <properties>
              <jboss.home>/home/kris/jboss-as-7.1.0.Beta1</jboss.home>
           </properties>
        </profile>
     </profiles>
 ...
 This will deploy two artifacts, target/eklerk.war and
 default-ds.xml.
 ...
 Now you can either deploy the target/eklerk.war through the
 web-based GlassFish admininstration console, or you can again use asadmin:

  ./asadmin deploy target/eklerk.war

 To undeploy the application, run:

  ./asadmin undeploy eklerk
